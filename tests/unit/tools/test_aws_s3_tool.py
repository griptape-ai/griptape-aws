...
class TestAwsS3Tool:
    ...
    def test_get_bucket_acl(self, session):
        ...
        assert (
            ...
            in AwsS3Tool(session=session).get_bucket_acl({"values": value}).value
        )
    ...
    def test_get_bucket_policy(self, session):
        ...
        assert (
            ...
            in AwsS3Tool(session=session).get_bucket_policy({"values": value}).value
        )
    ...
    def test_get_object_acl(self, session):
        ...
        assert (
            ...
            in AwsS3Tool(session=session).get_object_acl({"values": value}).value
        )
    ...
    def test_list_objects(self, session):
        ...
        assert (
            ...
            in AwsS3Tool(session=session).list_objects({"values": value}).value
        )
    ...
    def test_upload_content_to_s3(self, session):
        ...
        assert (
            ...
            in AwsS3Tool(session=session).upload_content_to_s3({"values": value}).value
        )
    ...
    def test_download_objects(self, session):
        ...
        assert (
            ...
            in AwsS3Tool(session=session).download_objects({"values": value}).value
        )
